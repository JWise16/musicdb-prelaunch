...
export const BookingPreferencesStep: React.FC<StepProps> = ({ 
  onPrevious, 
  onNext,
  isFirst, 
  isLast, 
  ...
  const selectedOptions = watch('booking_priorities') || []
  ...
  const handleCheckboxChange = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    setValue('booking_priorities', newSelected)
  }
      ...
      <div className="max-w-4xl mx-auto px-8 py-16">
        ...
        <div className="space-y-12">
          <div className="text-left">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-12">What matters to you most when booking an artist?</h1>
          ...
          <div className="space-y-8 mb-16">
            ...
            {selectedOptions.includes('other') && (
              <div className="mt-8">
                <input
                  {...register('booking_priorities_other')}
                ...
                />
                {errors.booking_priorities_other && (
                  <p className="mt-2 text-sm text-red-600">{errors.booking_priorities_other?.message as string}</p>
                )}
              </div>
            )}
          </div>
